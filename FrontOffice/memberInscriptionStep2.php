			...
			<div class="inside">
				<div class="container">
					...
					<div class="content">
						...
						<div class="img-box1">
							<b class="txt2">Inscription Membre du comité scientifique : Etape 2</b>
						</div>	
						...
						?>
						<form method="post" action="control/memberInscriptionStep2Action.php">
