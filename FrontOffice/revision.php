		...
		<div class="row-1">
			<div class="inside">
				<div class="container">
					...
					<!--Contenu-->
					<div class="content">
					<h3><?php echo DESC_COMITE;?></h3>
					<fieldset style="border:2px solid 	#008B8B;border-radius:8px;">
						<legend><b style="color:#6A5ACD; font-size:15px;  ">Détails De Révisions</b></legend>
						<br/>
						<li class="txt6">
							<?php
								$overview=file_get_contents('files/'.$_SESSION['lang'].'RevisionDetails.txt');
								echo nl2br($overview);
							?>
						</li><br/>
						</fieldset><br/><br/>
					<fieldset style="border:2px solid 	#008B8B;border-radius:8px;">
						<legend><b style="color:#6A5ACD; font-size:15px;  "><?php echo REVNOTICE;?></b></legend>
						<br/>
						<div class="wrapper2">
							<a href="../Revision/signUp.php" class="link1"><em><b><?php echo COMITEBT;?></b></em></a>
						</div>
						<br /><br />
						<div class="wrapper2">
							<a href="memberAccountSub.php" class="link1"><em><b><?php echo COMPTEBT;?></b></em></a>
						</div><br/>
						</fieldset><br/><br/>
