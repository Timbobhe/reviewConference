		...
		<div class="row-1">
			<div class="inside">
				<div class="container">
					...
					<!--Contenu-->
					<div class="content">
						<h3>Compte Membre du comité crée !</h3>
						<div class="img-box1">
							<b class="txt2">Votre compte en tant que membre du comité scientifique a été bien crée!</b>
						</div>
						<p>
							Vous pouvez desormais maintenant vous connecter à votre compte!<br />
							Utilisez votre email et votre mot de passe pour vous connecter.
						</p>
						<div class="img-box1">
							<b class="txt2"><?php echo SUBNOTICE;?></b>
						</div>
						<div class="wrapper">
