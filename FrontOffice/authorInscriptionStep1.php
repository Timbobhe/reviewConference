			...
			<div class="inside">
				<div class="container">
					...
					<div class="content" style="margin:auto;">
						...
						<div class="img-box1">
							<b class="txt2">Inscription Auteur : Etape 1</b>
						</div>	
						
						<div class="img-box1">
							<b class="txt2">Bonjour <?php echo $auteur->getNom();?> <?php echo $auteur->getPrenom();?></b>
						</div>	
						...
						<form method="post" action="control/authorInscriptionStep1Action.php">
						<fieldset style="border:2px solid 	#008B8B;border-radius:8px;">
							...
							<div class="field">
								...
								<?php 
								$auteur=unserialize($_SESSION["auteur"]);
								$Soumissions=SoumissionDao::getList1($auteur->getId());
								
								$idArticles;
								foreach ($Soumissions as $s){
									$idArticles[]=$s->getIdArticle();
								}
								if(isset($idArticles)){
