		...
		<div class="row-1">
			<div class="inside">
				<div class="container">
					...
					<!--Contenu-->
					<div class="content">
						<h3>Compte auteur crée !</h3>
						<div class="img-box1">
							<b class="txt2">Votre compte auteur a été bien crée!</b>
						</div>
						<p>
							Vous pouvez desormais maintenant vous connecter pour soumettre des articles!<br />
						</p>
						<div class="img-box1">
