		...
		<section id="main" class="column">
			...
			<h4 class="alert_info">Ces informations seront affichés sur le site de la conférence</h4>
				...
				<article class="module width_full">
					<header><h3 class="tabs_involved">&nbsp;&nbsp;Page de soumission</h3>
						<ul class="tabs">
					...
					<div class="tab_container">	
						...
						<div id="tab1" class="tab_content" style="margin: 10px 20px;color: #666;">
							...
							<form method="POST" action="control/toSubmissionAction.php?lang=fr">
								<div class="module_content">
									<fieldset>
										<label for="texte" style="width:200px;float:left;" >Conditions de soumission : </label>
										<textarea name="texte" cols="81" rows="20" ><?php readfile('../FrontOffice/files/frSubmissionDetails.txt') ?></textarea>
									</fieldset>
						...
						<div id="tab2" class="tab_content" style="margin: 10px 20px;color: #666;">
							...
							<form method="POST" action="control/toSubmissionAction.php?lang=en">
								<div class="module_content">
									<fieldset>
										<label for="texte" style="width:200px;float:left;" >Conditions de soumission : </label>
										<textarea name="texte" cols="81" rows="20" ><?php readfile('../FrontOffice/files/enSubmissionDetails.txt') ?></textarea>
									</fieldset>
									<div class="submit_link">
