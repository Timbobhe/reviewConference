...
<body>
	...
	<!--  start login-inner -->
	<div id="login-inner">
	<h3 style="font-size:18px;color:white; text-shadow:#000000 1px 1px,#000000 -1px 1px,#000000 -1px -1px,#000000 1px -1px; width:500px">Connexion au compte Membre De Comité : </h3>
